...
import io.richel.curso.domain.Pagamento;
import io.richel.curso.domain.PagamentoComBoleto;
import io.richel.curso.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void InstatiateTestDatabase() throws ParseException {
		...
		Categoria cat5 = new Categoria(null, "Pechincha");
		Categoria cat6 = new Categoria(null, "Dia-a-dia");
		Categoria cat7 = new Categoria(null, "Promoção");
		Categoria cat8 = new Categoria(null, "Auto");
		Categoria cat9 = new Categoria(null, "Beleza");
		Categoria cat10 = new Categoria(null, "Em Alta");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "richelsensineli@gmail.com", "25600518005", TipoCliente.PESSOAFISICA, bCrypt.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "cenciarelli@outlook.com", "45616484024", TipoCliente.PESSOAFISICA, bCrypt.encode("123"));
		...
		Endereco e3 = new Endereco(null, "Avenida do Estado", "1005", "Apto 800", "Centro", "38777012", cli2, c2);
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("20/08/2019 09:09"), null);
